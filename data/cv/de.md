...
<ul class="list-disc pl-5 space-y-2 mb-5">
<li>Administration und Wartung von Server- und Netzwerkinfrastruktur (Debian Linux, Windows)</li>
...
<p>Netzwerkadministration, Netzwerkprotokolle (TCP/IP, DNS, DHCP u.v.m.), Routing & Switching, Virtualisierung, Datenbanken/SQL, OOP-Grundlagen (C), Linux, Storage-Management, Skripting & Automatisierung (Bash, PowerShell)</p>
...
<p>Betriebswirtschaft, Rechnungswesen, Projektmanagement, Marketingstrategien, Business-Planung</p>
