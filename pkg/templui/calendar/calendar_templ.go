...
import (
	...
	"github.com/srkn0/main/pkg/templui/utils"
	"strconv"
	"time"
)
...
func Calendar(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 1, Col: 0}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 104, Col: 24}
		}
		...
		if !p.HideHiddenInput {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 110, Col: 17}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 111, Col: 30}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 112, Col: 25}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 117, Col: 12}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 120, Col: 53}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 121, Col: 63}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 122, Col: 61}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 123, Col: 55}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 124, Col: 60}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 140, Col: 34}
		}
		...
		for i := 0; i < 12; i++ {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 146, Col: 39}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 146, Col: 121}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 147, Col: 24}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 152, Col: 39}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 152, Col: 68}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 160, Col: 33}
		}
		...
		for year := 2100; year >= 1900; year-- {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 166, Col: 42}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 167, Col: 29}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 172, Col: 38}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templui/calendar/calendar.templ`, Line: 172, Col: 68}
		}
